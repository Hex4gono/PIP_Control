...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ConfiguracionButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../assets/configGear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ConfiguracionButton.setIcon(icon)
        self.ConfiguracionButton.setIconSize(QtCore.QSize(40, 40))
